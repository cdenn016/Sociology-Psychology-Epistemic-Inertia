...
\begin{abstract}
Phenomenological mass/spring models of belief dynamics have proven empirically successful yet lack theoretical justification. We show that variational free energy minimization on statistical manifolds naturally identifies the Fisher information metric as a tensor playing the role of inertial mass---confident beliefs resist change while uncertain beliefs update readily. We define proper time as information-theoretic arc length, providing a principled notion of ``how long'' belief updates take that depends on agent precision. Social interactions are encoded via gauge-invariant attention mechanisms.

We present a Hamiltonian formulation of belief dynamics as a fruitful ansatz. Crucially, in the overdamped limit---which does not depend on this ansatz---we derive several classical sociological models as exact or approximate limiting cases: DeGroot, Friedkin-Johnsen, bounded confidence, echo chambers, Social Impact Theory, and diffusion of innovations. In underdamped regimes, the ansatz predicts oscillation, overshooting, and resonance. The framework reframes confirmation bias, belief perseverance, and polarization as geometric consequences of epistemic inertia rather than irrationality.
\end{abstract}
